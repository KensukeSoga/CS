...
public class SeikyuYymmChangeVO implements Serializable {
     ...
     * @return 変更後請求年月
     */
    public String getYymmNew() {
        return _yymmNew;
    }

    /**
     * 変更後請求年月を設定する
     * @param String 変更後請求年月
     */
    public void setYymmNew(String yymmNew) {
        this._yymmNew = yymmNew;
    }
