...
public class AccountSecurityRoleManager {
     ...
     */
    public String getAccountSecurityRole(AccountSecurityRoleCondition cond) throws KKHException {
     ...
     * @throws KKHException 処理中にエラーが発生した場合
     */
    private String getRelativeAuthority(String xmlRecords) throws KKHException {
        ...
        try {
            ...
            throw new KKHException("セキュリィティデータ取得エラー", "HB-W0100");
        }
    }
     ...
     * @throws KKHException 処理中にエラーが発生した場合
     */
    private static String getCharacterDataFromElement(Element e) throws KKHException {
