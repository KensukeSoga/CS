...
public class DetailListLionMobileDAO extends AbstractRdbDao implements  DetailListLionDaoInterface{
...
//	};
     ...
     * デフォルトコンストラクタ。
     */
    public DetailListLionMobileDAO() {
    ...
    private String getSelectSQLForItem() {
        ...
        sql.append("  mast1." + TBTHBAMST.FIELD1 + " " + DetailListLionVO.KYOKUSHI_CD + ", ");
        sql.append("  mast1." + TBTHBAMST.FIELD2 + " " + DetailListLionVO.KYOKUSHI_NAME + " ");
        sql.append(" FROM ");
        ...
        sql.append(" " + TBTHB2KMEI.CODE6 + " IN ('018') AND ");
        ...
        sql.append(" mast1." + TBTHBAMST.TKSKGYCD + " (+) = " + TBTHB2KMEI.TKSKGYCD +" AND ");
        sql.append(" mast1." + TBTHBAMST.TKSBMNSEQNO + " (+) = " + TBTHB2KMEI.TKSBMNSEQNO +" AND ");
        sql.append(" mast1." + TBTHBAMST.TKSTNTSEQNO + " (+) = " + TBTHB2KMEI.TKSTNTSEQNO +" AND ");
        sql.append(" mast1." + TBTHBAMST.SYBT + " (+) = '115' AND ");
        sql.append(" mast1." + TBTHBAMST.FIELD1 + " (+) = TRIM(" + TBTHB2KMEI.CODE2 +")  ");
        sql.append(" ORDER BY ");
        sql.append("  " + TBTHB2KMEI.YYMM + ", ");
    ...
    protected List<DetailListLionVO> createFindedModelInstances(List hashList) {
        ...
        if (getModel() instanceof DetailListLionVO) {
            for (int i = 0; i < hashList.size(); i++) {
                ...
                vo.setKyokushiCd((String) result.get(DetailListLionVO.KYOKUSHI_CD.toUpperCase().trim())); //局誌コード
                vo.setKyokushiName((String) result.get(DetailListLionVO.KYOKUSHI_NAME.toUpperCase().trim())); //局誌名
