...
public class DetailListLionTiraShiDAO extends AbstractRdbDao implements  DetailListLionDaoInterface{
...
//	};
     ...
     * デフォルトコンストラクタ。
     */
    public DetailListLionTiraShiDAO() {
    ...
    private String getSelectSQLForItem() {
        ...
        sql.append(" " + TBTHB2KMEI.CODE6 + " IN ('014') AND ");
