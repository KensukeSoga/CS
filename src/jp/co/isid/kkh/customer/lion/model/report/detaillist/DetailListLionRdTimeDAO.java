...
public class DetailListLionRdTimeDAO extends AbstractRdbDao implements  DetailListLionDaoInterface{
...
//	};
     ...
     * デフォルトコンストラクタ。
     */
    public DetailListLionRdTimeDAO() {
...
//						+ "DECODE(TRIM(" + TBTHB2KMEI.RITU1  + ") , NULL , 5 , " + TBTHB2KMEI.RITU1   + ")" + "/ 100 )" + " AS SHOHIZEI_GAK " + " ");	//消費税額
        ...
        sql.append(" ," + "mast1.HB10_BANCD" 	+ " AS " + DetailListLionVO.BANGUMI_CD	+ " ");	//番組コード
        sql.append(" ," + "mast1.HB10_BANNAME" 	+ " AS " + DetailListLionVO.BANGUMI_MEI	+ " ");	//番組名
