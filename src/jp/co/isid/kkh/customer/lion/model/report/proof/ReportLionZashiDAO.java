...
public class ReportLionZashiDAO extends AbstractRdbDao implements  ReportLionProofDaoInterface{
...
//	};
    ...
    private String getSelectSQLForItem() {
        ...
        sql.append(" " + TBTHB2KMEI.CODE2 + " " + ReportLionVO.ZASHI_CD + ", ");
        sql.append(" " + TBTHB2KMEI.NAME2 + " " + ReportLionVO.SPACE + ", ");
        ...
        sql.append("  mast1." + TBTHBAMST.FIELD2 + " " + ReportLionVO.ZASHI_NAME + " ");
        sql.append(" FROM ");
    ...
    protected List<ReportLionVO> createFindedModelInstances(List hashList) {
        ...
        if (getModel() instanceof ReportLionVO) {
            for (int i = 0; i < hashList.size(); i++) {
                ...
                vo.setZashiCd((String) result.get(ReportLionVO.ZASHI_CD.toUpperCase().trim()));
                vo.setSpace((String) result.get(ReportLionVO.SPACE.toUpperCase().trim()));
                ...
                vo.setZashiName((String) result.get(ReportLionVO.ZASHI_NAME.toUpperCase().trim()));     //雑誌名
