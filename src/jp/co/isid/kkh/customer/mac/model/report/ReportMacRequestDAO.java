 ...
 * @author JSE KT
 */
public class ReportMacRequestDAO extends AbstractSimpleRdbDao {

    /**汎用マスタ検索条件 */
    private ReportMacRequestCondition _cond;

    /**
     * デフォルトコンストラクタ。
     */
    public ReportMacRequestDAO() {
    ...
    public String[] getTableColumnNames() {
        return new String[]{
                ...
                TBTHBAMST.FIELD5,	// 住所１
                TBTHBAMST.FIELD6,	// 住所２
                TBTHBAMST.FIELD4,	// 郵便番号
    ...
    private String getSelectSQLForPrint(){
        ...
        if (_cond.gettenpoKbn().equals("1"))
        {
            sql.append("  RTRIM(" + TBTHB2KMEI.KBN1 + ") = '2' AND ");
        }
        else if (_cond.gettenpoKbn().equals("0"))
        {
            sql.append("  RTRIM(" + TBTHB2KMEI.KBN1 + ") != '2' AND ");
        }
        ...
        sql.append("  RTRIM(" + TBTHB2KMEI.DATE2 + ") IS NULL  ");
        sql.append("  ORDER BY ");
    ...
    private String getSelectSQLForRePrint(){
        ...
        sql.append(TBTHB1DOWN.EGCD + " = " + TBTHB2KMEI.EGCD);
        sql.append(" AND " + TBTHB1DOWN.TKSKGYCD + " = " + TBTHB2KMEI.TKSKGYCD);
        sql.append(" AND " + TBTHB1DOWN.TKSBMNSEQNO + " = " + TBTHB1DOWN.TKSBMNSEQNO);
        sql.append(" AND " + TBTHB1DOWN.TKSTNTSEQNO + " = " + TBTHB2KMEI.TKSTNTSEQNO);
        sql.append(" AND " + TBTHB1DOWN.YYMM + " = " + TBTHB2KMEI.YYMM);
        sql.append(" AND " + TBTHB1DOWN.JYUTNO + " = " + TBTHB2KMEI.JYUTNO);
        sql.append(" AND " + TBTHB1DOWN.JYMEINO + " = " + TBTHB2KMEI.JYMEINO);
        ...
        sql.append("  RTRIM(" + TBTHB2KMEI.DATE2 + ") IS NOT NULL  ");
        sql.append("  ORDER BY ");
        sql.append("  " + TBTHBAMST.FIELD1  + ", ");
    ...
    public List<ReportMacRequestVO> findReportMacRequestByCondition(ReportMacRequestCondition cond) throws KKHException {

        super.setModel(new ReportMacRequestVO());
