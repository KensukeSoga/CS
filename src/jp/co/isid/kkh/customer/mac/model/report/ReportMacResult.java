...
public class ReportMacResult extends AbstractServiceResult {
	/** マスタ種類設定VOリスト */
	private List<ReportMacVO> _Rep;

	/**
	 * マスタ項目設定VOリストを取得します。
	 * @return _masterItem
	 */
	public List<ReportMacVO> getReportMac() {
		return _Rep;
	}
	 ...
	 */
	public void setReportMac(List<ReportMacVO> rep) {
		_Rep = rep;
	}
