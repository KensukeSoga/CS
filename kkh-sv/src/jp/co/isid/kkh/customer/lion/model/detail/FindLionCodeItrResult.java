...
public class FindLionCodeItrResult extends AbstractServiceResult {
	/** マスタ種類設定VOリスト */
	private List<FindLionCodeItrVO> _Rep;

	/**
	 * マスタ項目設定VOリストを取得します。
	 * @return _masterItem
	 */
	public List<FindLionCodeItrVO> getFindLionCodeItr() {
		return _Rep;
	}
	 ...
	 */
	public void setFindLionCodeItr(List<FindLionCodeItrVO> rep) {
		_Rep = rep;
	}
