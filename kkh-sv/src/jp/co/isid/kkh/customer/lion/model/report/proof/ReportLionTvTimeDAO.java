...
public class ReportLionTvTimeDAO extends AbstractRdbDao implements  ReportLionProofDaoInterface{
...
//						+ "TRIM(" + TBTHB2KMEI.RITU1  + ")  / 100  )" + " AS SHOHIZEI_GAK " 	+ " ");	//消費税額
        ...
        sql.append(" ," + "mast1.HB9_BANCD" 	+ " AS " + ReportLionVO.BANGUMI_CD	+ " ");	//番組コード
        sql.append(" ," + "mast1.HB9_BANNAME" 	+ " AS " + ReportLionVO.BANGUMI_MEI	+ " ");	//番組名
