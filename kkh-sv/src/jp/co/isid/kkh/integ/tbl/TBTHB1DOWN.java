...
public class TBTHB1DOWN {
    ...
    /** 受注ダウンロードテーブル */
    public static final String TBNAME = "THB1DOWN";

    /** カラム名のプレフィックス */
    public static final String PREFIX = "HB1_";
    ...
    /** 受注明細フラグ (JYUTMEISAIFLG) */
    public static final String MEISAIFLG = PREFIX + "JYUTMEISAIFLG";

    /** スペース２ (SPACE2) */
    public static final String SPACE2 = PREFIX + "SPACE2";
}