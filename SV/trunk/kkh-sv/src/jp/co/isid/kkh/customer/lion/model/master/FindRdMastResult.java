...
public class FindRdMastResult extends AbstractServiceResult {
	/** マスタ種類設定VOリスト */
	private List<FindRdMastVO> _Rep;

	/**
	 * マスタ項目設定VOリストを取得します。
	 * @return _masterItem
	 */
	public List<FindRdMastVO> getFindRdMast() {
		return _Rep;
	}
	 ...
	 */
	public void setFindRdMast(List<FindRdMastVO> rep) {
		_Rep = rep;
	}
