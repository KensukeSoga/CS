...
public class Thb1DownVO extends AbstractModel {
    ...
    */
    public void setHb1MeiTimStmp(String val) {
        set(TBTHB1DOWN.MEITIMSTMP, val);
    }
     ...
     */
    public String getHb1MeiTimStmp() {
        return (String) get(TBTHB1DOWN.MEITIMSTMP);
    }
     ...
     * @return 受注明細フラグ
     */
    public String getHb1MeisaiFlg() {
        return (String) get(TBTHB1DOWN.MEISAIFLG);
    }
     ...
     * @param val 受注明細フラグ
     */
    public void setHb1MeisaiFlg(String val) {
        set(TBTHB1DOWN.MEISAIFLG, val);
    }
    ...
    public String getSpace2() {
        return (String) get(TBTHB1DOWN.SPACE2);
    }
