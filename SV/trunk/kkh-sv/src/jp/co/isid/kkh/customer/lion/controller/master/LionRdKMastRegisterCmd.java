...
import jp.co.isid.kkh.customer.lion.model.master.LionRdKMastDataInsertVO;
import jp.co.isid.kkh.customer.lion.model.master.LionRdKMastDataVO;
 ...
 * @author JSE A.Naito
 */
public class LionRdKMastRegisterCmd extends Command {

    private static final long serialVersionUID = 1L;

    /** マスタデータ登録処理用VO */
    private LionRdKMastRegisterVO _vo;
    ...
    public void execute() throws KKHException {
        ...
        //削除開始
        manager.deleteLionRdKMastDataByCondition(mastercondition);

        //Insert開始
        if (_vo.getLionData() != null) {
            List<LionRdKMastDataInsertVO> insertVOList = new ArrayList<LionRdKMastDataInsertVO>();
            insertVOList =  editDefineInsertVo(_vo,_vo.get_sybt());

            manager.registerLionRdKMast(insertVOList);
        }
     ...
     * @param vo マスタデータ登録VO
     */
    public void setLionRdKMastRegisterVO(LionRdKMastRegisterVO vo) {
        _vo = vo;
    }
...
//	}
    ...
    private List<LionRdKMastDataInsertVO> editDefineInsertVo(LionRdKMastRegisterVO masterRegisterVO, String Sybt)
    {
        List<LionRdKMastDataInsertVO> insertVOList = new ArrayList<LionRdKMastDataInsertVO>();

        List<LionRdKMastDataVO> mstdatavo = masterRegisterVO.getLionData();

        for(LionRdKMastDataVO mstvo : mstdatavo)
        {
            LionRdKMastDataInsertVO addrow = new LionRdKMastDataInsertVO();
