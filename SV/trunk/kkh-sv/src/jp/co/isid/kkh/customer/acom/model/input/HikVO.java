...
public class HikVO extends AbstractModel {
     ...
     */
    public void setTrkTimStmp(String val) {
     ...
     */
    public String getTrkTimStmp() {
        return (String) get(TBTHB5HIK.TRKTIMSTMP);
    }
     ...
     */
    public void setUpdTimStmp(String val) {
     ...
     */
    public String getUpdTimStmp() {
        return (String) get(TBTHB5HIK.UPDTIMSTMP);
    }
