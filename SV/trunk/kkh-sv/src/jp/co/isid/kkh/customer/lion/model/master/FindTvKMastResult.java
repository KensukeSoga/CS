...
public class FindTvKMastResult extends AbstractServiceResult {
	/** マスタ種類設定VOリスト */
	private List<FindTvKMastVO> _Rep;

	/**
	 * マスタ項目設定VOリストを取得します。
	 * @return _masterItem
	 */
	public List<FindTvKMastVO> getFindTvKMast() {
		return _Rep;
	}
	 ...
	 */
	public void setFindTvKMast(List<FindTvKMastVO> rep) {
		_Rep = rep;
	}
