 ...
 * @author JSE A.Naito
 */
public class LionRdMastRegisterVO extends AbstractModel {
    ...
    /** 汎用マスタデータVOリスト */
    private List<LionRdMastDataVO> _masterData = null;
     ...
     */
    public List<LionRdMastDataVO> getLionData() {
        return _masterData;
    }
     ...
     */
    public void setLionData(List<LionRdMastDataVO> masterData) {
