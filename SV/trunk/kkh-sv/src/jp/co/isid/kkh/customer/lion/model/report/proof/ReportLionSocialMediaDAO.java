 ...
 *
 * <P>
 * ライオンプルーフリスト帳票(ソーシャルメディア)検索DAO
 * </P>
 * <P>
 * <B>修正履歴</B><BR>
 * ・新規作成(2017/06/05 ITCOM A.Nakamura)<BR>
 * </P>
 *
 * @author
 */

 public class ReportLionSocialMediaDAO extends AbstractRdbDao implements  ReportLionProofDaoInterface{
     ...
     * デフォルトコンストラクタ。
     */
    public ReportLionSocialMediaDAO() {
